...
Сбрасываете нейросети ссылку на спецификацию формата (можете добавить в персонализацию). Сбрасываете тексты исходного кода своего софта и относительные пути к файлам. И получаете ответ в форме легкоприменимом с помощью утилиты `chunk`:
