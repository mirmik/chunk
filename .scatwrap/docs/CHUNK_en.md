...
*&nbsp;for&nbsp;language&nbsp;commands&nbsp;(`replace_c_style_block`,&nbsp;`replace_py_block`)&nbsp;—&nbsp;the&nbsp;line&nbsp;with&nbsp;the&nbsp;block&nbsp;“header”&nbsp;(function&nbsp;signature,&nbsp;`if&nbsp;...`,&nbsp;`for&nbsp;...`,&nbsp;`def&nbsp;...`,&nbsp;`class&nbsp;...`&nbsp;and&nbsp;so&nbsp;on).<br>
<br>
...
---<br>
<br>
##&nbsp;6.&nbsp;Commands&nbsp;for&nbsp;C-style&nbsp;and&nbsp;Python&nbsp;blocks<br>
<br>
