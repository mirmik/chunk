...
<br>
TEST_CASE(&quot;YAML&nbsp;parser&nbsp;handles&nbsp;YAML&nbsp;comments&nbsp;and&nbsp;hashes&nbsp;inside&nbsp;scalars&quot;)<br>
{<br>
&nbsp;&nbsp;&nbsp;&nbsp;const&nbsp;char&nbsp;*src&nbsp;=<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;#&nbsp;top-level&nbsp;comment\n&quot;<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;auto&nbsp;dict&nbsp;=&nbsp;nos::yaml::parse(src).as_dict();<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(dict.at(&quot;value&quot;).as_string()&nbsp;==&nbsp;&quot;data&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(dict.at(&quot;list&quot;).as_list().at(0).as_string()&nbsp;==&nbsp;&quot;item&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(dict.at(&quot;quoted&quot;).as_string()&nbsp;==&nbsp;&quot;text&nbsp;#&nbsp;inside&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(dict.at(&quot;single&quot;).as_string()&nbsp;==&nbsp;&quot;hash&nbsp;#here&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(dict.at(&quot;block&quot;).as_string()&nbsp;==<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;line&nbsp;with&nbsp;#&nbsp;hash\n#&nbsp;leading&nbsp;hash\n&quot;);<br>
}<br>
<br>
