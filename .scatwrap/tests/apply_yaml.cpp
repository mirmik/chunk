...
{<br>
public:<br>
&nbsp;&nbsp;&nbsp;&nbsp;ScopedStreamSilence()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;old_cout(std::cout.rdbuf()),&nbsp;old_cerr(std::cerr.rdbuf())<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;std::cout.rdbuf(sink.rdbuf());<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;std::cerr.rdbuf(sink.rdbuf());<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;~ScopedStreamSilence()<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;std::cout.rdbuf(old_cout);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;std::cerr.rdbuf(old_cerr);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
private:<br>
&nbsp;&nbsp;&nbsp;&nbsp;std::ostringstream&nbsp;sink;<br>
&nbsp;&nbsp;&nbsp;&nbsp;std::streambuf&nbsp;*old_cout;<br>
&nbsp;&nbsp;&nbsp;&nbsp;std::streambuf&nbsp;*old_cerr;<br>
};<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;ScopedStreamSilence&nbsp;silence;<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(run_apply(patch)&nbsp;!=&nbsp;0);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;auto&nbsp;L&nbsp;=&nbsp;read_lines(f);<br>
&nbsp;&nbsp;&nbsp;&nbsp;REQUIRE(L.size()&nbsp;==&nbsp;2);<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;auto&nbsp;original_time&nbsp;=<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs::file_time_type::clock::now()&nbsp;-&nbsp;std::chrono::hours(1);<br>
...
<br>
//&nbsp;On&nbsp;Windows,&nbsp;permissions&nbsp;handling&nbsp;is&nbsp;different&nbsp;(NTFS&nbsp;ACLs&nbsp;vs&nbsp;POSIX&nbsp;perms)<br>
//&nbsp;So&nbsp;we&nbsp;skip&nbsp;the&nbsp;permissions&nbsp;check&nbsp;on&nbsp;Windows<br>
#ifndef&nbsp;_WIN32<br>
...
{<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::path&nbsp;tmp&nbsp;=<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs::temp_directory_path()&nbsp;/&nbsp;&quot;yaml_cpp_prefer_exact_with_comments&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::remove_all(tmp);<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::create_directories(tmp);<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::path&nbsp;f&nbsp;=&nbsp;tmp&nbsp;/&nbsp;&quot;code.cpp&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
...
<br>
//&nbsp;============================================================================<br>
//&nbsp;22.&nbsp;UTF-8:&nbsp;Cyrillic&nbsp;marker&nbsp;and&nbsp;payload<br>
//&nbsp;============================================================================<br>
TEST_CASE(&quot;YAML&nbsp;patch:&nbsp;UTF-8&nbsp;Cyrillic&nbsp;marker&nbsp;and&nbsp;payload&quot;)<br>
{<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::path&nbsp;tmp&nbsp;=&nbsp;fs::temp_directory_path()&nbsp;/&nbsp;&quot;yaml_patch_cyrillic&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::remove_all(tmp);<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::create_directories(tmp);<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::path&nbsp;f&nbsp;=&nbsp;tmp&nbsp;/&nbsp;&quot;file.txt&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
