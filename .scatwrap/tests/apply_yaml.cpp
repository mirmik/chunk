...
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(nos::trim(L[2])&nbsp;==&nbsp;nos::trim(&quot;return&nbsp;100&quot;));<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(nos::trim(L[3])&nbsp;==&nbsp;nos::trim(&quot;def&nbsp;other(self):&quot;));<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(nos::trim(L[4])&nbsp;==&nbsp;nos::trim(&quot;return&nbsp;2&quot;));<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Старый&nbsp;run()&nbsp;исчез<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(all.find(&quot;return&nbsp;1&quot;)&nbsp;==&nbsp;std::string::npos);<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Новый&nbsp;run()&nbsp;появился<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(all.find(&quot;def&nbsp;run(self):&quot;)&nbsp;!=&nbsp;std::string::npos);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(all.find(&quot;return&nbsp;100&quot;)&nbsp;!=&nbsp;std::string::npos);<br>
