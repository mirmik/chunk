...
//&nbsp;============================================================================<br>
TEST_CASE(&quot;YAML&nbsp;patch:&nbsp;marker&nbsp;matches&nbsp;across&nbsp;empty&nbsp;lines&nbsp;in&nbsp;file&quot;)<br>
{<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::path&nbsp;tmp&nbsp;=&nbsp;fs::temp_directory_path()&nbsp;/&nbsp;&quot;yaml_patch_marker_empty_lines&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::remove_all(tmp);<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::create_directories(tmp);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::path&nbsp;f&nbsp;=&nbsp;tmp&nbsp;/&nbsp;&quot;file.txt&quot;;<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;auto&nbsp;L&nbsp;=&nbsp;read_lines(f);<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Конкретное&nbsp;поведение&nbsp;сейчас&nbsp;такое:<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;&nbsp;&nbsp;AAA&nbsp;+&nbsp;пустая&nbsp;строка&nbsp;заменяются&nbsp;на&nbsp;XXX/YYY,<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;&nbsp;&nbsp;строка&nbsp;BBB&nbsp;остаётся&nbsp;(мы&nbsp;игнорируем&nbsp;пустую&nbsp;при&nbsp;сравнении,&nbsp;но&nbsp;длину&nbsp;блока&nbsp;берём&nbsp;из&nbsp;маркера).<br>
&nbsp;&nbsp;&nbsp;&nbsp;REQUIRE(L.size()&nbsp;==&nbsp;4);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[0]&nbsp;==&nbsp;&quot;XXX&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[1]&nbsp;==&nbsp;&quot;YYY&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[2]&nbsp;==&nbsp;&quot;BBB&quot;);<br>
...
//&nbsp;============================================================================<br>
TEST_CASE(&quot;YAML&nbsp;patch:&nbsp;insert_after_text&nbsp;marker&nbsp;across&nbsp;empty&nbsp;line&quot;)<br>
{<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::path&nbsp;tmp&nbsp;=&nbsp;fs::temp_directory_path()&nbsp;/&nbsp;&quot;yaml_patch_insert_after_empty&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::remove_all(tmp);<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::create_directories(tmp);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs::path&nbsp;f&nbsp;=&nbsp;tmp&nbsp;/&nbsp;&quot;code.txt&quot;;<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;std::ofstream&nbsp;out(f);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;out&nbsp;&lt;&lt;&nbsp;&quot;begin\n&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;&lt;&nbsp;&quot;A\n&quot;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;а&nbsp;вставка&nbsp;происходит&nbsp;в&nbsp;позицию&nbsp;pos&nbsp;+&nbsp;marker.size()&nbsp;(как&nbsp;и&nbsp;раньше).<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;То&nbsp;есть&nbsp;X&nbsp;вставится&nbsp;ПЕРЕД&nbsp;B,&nbsp;потому&nbsp;что&nbsp;pos&nbsp;==&nbsp;индекс&nbsp;строки&nbsp;&quot;A&quot;.<br>
&nbsp;&nbsp;&nbsp;&nbsp;REQUIRE(L.size()&nbsp;==&nbsp;6);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[0]&nbsp;==&nbsp;&quot;begin&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[1]&nbsp;==&nbsp;&quot;A&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[2].empty());&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;пустая<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[3]&nbsp;==&nbsp;&quot;X&quot;);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;вставка&nbsp;сюда<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[4]&nbsp;==&nbsp;&quot;B&quot;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;CHECK(L[5]&nbsp;==&nbsp;&quot;end&quot;);<br>
}<br>
<!-- END SCAT CODE -->
