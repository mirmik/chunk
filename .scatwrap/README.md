...
<br>
Patches&nbsp;are&nbsp;written&nbsp;in&nbsp;the&nbsp;**chunk&nbsp;v2**&nbsp;YAML&nbsp;(YAML&nbsp;Ain't&nbsp;Markup&nbsp;Language)&nbsp;format,&nbsp;described&nbsp;in&nbsp;[`CHUNK.html`](https://mirmik.github.io/chunk/CHUNK.html).<br>
...
<br>
See&nbsp;[`CHUNK.html`](https://mirmik.github.io/chunk/CHUNK.html)&nbsp;or&nbsp;run:<br>
<br>
```bash<br>
chunk&nbsp;--help<br>
```<br>
