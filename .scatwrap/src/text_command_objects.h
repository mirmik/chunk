...
{<br>
class&nbsp;TextCommand<br>
{<br>
public:<br>
&nbsp;&nbsp;&nbsp;&nbsp;virtual&nbsp;~TextCommand()&nbsp;=&nbsp;default;<br>
&nbsp;&nbsp;&nbsp;&nbsp;virtual&nbsp;void&nbsp;execute(std::vector&lt;std::string&gt;&nbsp;&amp;lines)&nbsp;=&nbsp;0;<br>
};<br>
<br>
class&nbsp;SimpleInsertCommand&nbsp;:&nbsp;public&nbsp;TextCommand<br>
{<br>
public:<br>
...
<br>
class&nbsp;MarkerTextCommand&nbsp;:&nbsp;public&nbsp;TextCommand<br>
{<br>
public:<br>
...
<br>
using&nbsp;TextCommandFactory&nbsp;=<br>
&nbsp;&nbsp;&nbsp;&nbsp;std::function&lt;std::unique_ptr&lt;TextCommand&gt;(const&nbsp;Section&nbsp;&amp;,&nbsp;const&nbsp;std::string&nbsp;&amp;)&gt;;<br>
}&nbsp;//&nbsp;namespace&nbsp;text_commands_detail<br>
<br>
<!-- END SCAT CODE -->
</body>
